...
## 碎碎念
- 我喜欢用记账本, 它可以给我一些安全感, 让我知道我花了多少钱. 不会看着钱包发出疑问"哎! 我上个月工资去哪里了?"

- 我用了很多记事本, 他们的功能非常强, 有多个账本, 账号账单云端管理, 图表漂亮. 甚至还有ai分析给你一些建议. 我认为这些都很棒
.但是我想要简单一些, 不要广告, 不要账号, 让我知道我花了多少就行.所以我找到mine的时候,它仿佛散发着光芒.
...
- 我不是专业的安卓开发者, 代码已经尽可能优化了. 所以如果你是专业的安卓开发者, 使用后同样喜欢该项目, 可以联系我加入到项目.
  哦哦对了, 如果有想法或者电子可以给我创建lssues告诉我你的建议, 我会一一回复. 酌情考虑功能建议.
