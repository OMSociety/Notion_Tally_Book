...
前输入价格：8元/百万tokens 输出价格：24元/百万tokens, 1080x2400的图片加上提示词加上输出大概是3分/次.可以使用(Qwen-VL-Plus)
这个模型, 大概每次识别的价格会降低到1分/次. test版本(0.7.3测试版)中我增加了图片压缩, (qwen2.5-vl-32b-instruct)大概1分/每次, 
(Qwen-VL-Plus)大概会是0.16分/次
...
## 下载
- 也可以直接点击下载链接
- 我的版本: https://pan.baidu.com/s/10m2ESElusN1dXCN3TZFOug?pwd=7e6j 
